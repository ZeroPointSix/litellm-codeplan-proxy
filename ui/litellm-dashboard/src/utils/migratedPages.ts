...
export const MIGRATED_PAGES: Record<string, string> = {
  ...
  budgets: "budgets",
  workflows: "workflows",
  "codeplan-plans": "codeplan-plans",
  "codeplan-credit-rules": "codeplan-credit-rules",
  "codeplan-subscriptions": "codeplan-subscriptions",
  "codeplan-usage-ledger": "codeplan-usage-ledger",

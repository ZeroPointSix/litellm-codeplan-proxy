...
export const pageDescriptions: Record<string, string> = {
  ...
  "codeplan-plans": "Manage Code Plan packages, credit quotas, allowed models, and plan versions",
  "codeplan-credit-rules": "Manage Code Plan credit multipliers and rule versions",
  "codeplan-subscriptions": "Manage Code Plan project subscriptions and status actions",
  "codeplan-usage-ledger": "Inspect Code Plan usage ledger events and credit adjustments",
